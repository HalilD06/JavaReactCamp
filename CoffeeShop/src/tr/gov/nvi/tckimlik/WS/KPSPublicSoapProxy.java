...
public class KPSPublicSoapProxy implements tr.gov.nvi.tckimlik.WS.KPSPublicSoap {
  ...
  public boolean TCKimlikNoDogrula(Long long1, java.lang.String ad, java.lang.String soyad, int i) throws java.rmi.RemoteException{
    if (kPSPublicSoap == null)
      _initKPSPublicSoapProxy();
    return kPSPublicSoap.TCKimlikNoDogrula(long1, ad, soyad, i);
  }


@Override
public boolean TCKimlikNoDogrula(long TCKimlikNo, String ad, String soyad, String string2) throws RemoteException {
	// TODO Auto-generated method stub
	return false;
}

@Override
public boolean TCKimlikNoDogrula(long TCKimlikNo, String ad, String soyad, int i) throws RemoteException {
	// TODO Auto-generated method stub
	return false;
}
